...
public class Day16Tests
{
    ...
    public static IEnumerable<Func<(string, Point[][])>> MultiplePathsData()
    {
        ...
        [
            ...
            [new Point(3, 3), new Point(3, 2), new Point(3, 1), new Point(2, 1), new Point(1, 1), new Point(1, 2), new Point(1, 3)],
            [new Point(3, 3), new Point(3, 4), new Point(3, 5), new Point(2, 5), new Point(1, 5), new Point(1, 4), new Point(1, 3)]
        ]);
    }
